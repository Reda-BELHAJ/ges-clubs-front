...
const AdminCards = ({num, title, per}) => {
  return (
      <div className='mb-3 lg:mb-0 border-gray-300 rounded-xl border'>
          <div className="shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div className="flex items-center">
                <div className="flex-shrink-0">
                    <span className="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{num}</span>
